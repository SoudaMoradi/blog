...
function Login(props) {
    ...
    return (
        <div className="h-full flex justify-content-center align-items-center">
            <div className="flex flex-column justify-content-center align-items-center w-4 border-round-xl shadow-2 gap-3">
             <div className="w-8">
                 <div className="p-3 text-center">
                     <span className="text-2xl font-bold font-italic text-primary-900">شرکت رها صنعت</span>
                 </div>
                 <div className="flex flex-column w-full">
                     <label className="text-sm text-right font-bold pb-1">ورود</label>
                 ...
                 <div className="flex justify-content-center gap-3 pt-4 pb-4">
                     <Button className="p-button-outlined border-primary-900 text-primary-900 text-xs p-2" style={{width:'10rem'}} label={'دریافت کد فعال سازی'}/>
                     <Button className="p-button-text bg-primary-900 text-white text-xs p-1" style={{width:'10rem'}} label={'ورود'} onClick={()=>{requestLogin() }}/>
                 </div>
             </div>
